...
def visualize(all_data, outfile_base_name, normalize, fn):
    ...
    var_names = ["DOT_r", "DOT_\u03B1", "MATVEC", "WXPY_p", "WXPY_x", "WXPY_r"]
...
if __name__ == "__main__":
    ...
    with open(json_results_path) as f:
        ...
        visualize(all_data.copy(), outfile_base_name, False, fn)
#        visualize(all_data.copy(), outfile_base_name, normalize=True)
